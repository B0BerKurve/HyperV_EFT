...
HyperV::HyperV()
{
	printf("[+] Wait for EscapeFromTarkov...\n");
	//printf("-------------------------------\n");
...
bool HyperV::ReadMem1(uintptr_t Address, PVOID value, ULONG write_size)
{
	ULONG Value = ExCopyVirt(ExtendCr3, (ULONG64)(Address), CurentCr3, (ULONG64)value, write_size);
	if (0 == Value)
		return true;
